...
Font Licenses:
* DejaVuLGCSansMono.ttf: custom (see [files/data/fonts/DejaVuFontLicense.txt](https://github.com/TES3MP/TES3MP/blob/master/files/data/fonts/DejaVuFontLicense.txt) for more information)
