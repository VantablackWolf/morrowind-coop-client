...
int main()
{
    { // Potion: mAutoCalc <-> mFlags rename
        records::Potion p{}; p.mId="p_restore_health"; p.mScript="myscript";
        p.mData.mWeight=0.5f; p.mData.mValue=25; p.mData.mAutoCalc=1;
        auto b=trip<records::Potion,ESM::Potion>(p);
    ...
    { // Miscellaneous: mIsKey <-> mFlags rename
        records::Miscellaneous m{}; m.mId="misc_key"; m.mData.mIsKey=1; m.mData.mValue=7;
        auto b=trip<records::Miscellaneous,ESM::Miscellaneous>(m);
        ck("Misc mIsKey survives rename to mFlags", b.mData.mIsKey==1 && b.mData.mValue==7);
    }
    { // Weapon: std::array damage pairs
        records::Weapon w{}; w.mId="iron dagger"; w.mEnchant="ench1";
        w.mData.mChop[0]=2; w.mData.mChop[1]=8;
        w.mData.mSlash[0]=3; w.mData.mSlash[1]=9;
        w.mData.mThrust[0]=4; w.mData.mThrust[1]=10;
        auto b=trip<records::Weapon,ESM::Weapon>(w);
    ...
    { // Ingredient: RefId[4] arrays with -1 for unused slots
        records::Ingredient g{}; g.mId="ingred_test";
        ...
        auto b=trip<records::Ingredient,ESM::Ingredient>(g);
    ...
    { // Creature: int[6] attack array + AI + inventory
        records::Creature c{}; c.mId="rat_test"; c.mScript="";
        ...
        auto b=trip<records::Creature,ESM::Creature>(c);
    ...
    { // NPC: many refIds + NPDT + shared structs
        records::NPC n{}; n.mId="test_npc"; n.mRace="dark elf"; n.mClass="acrobat";
        ...
        auto b=trip<records::NPC,ESM::NPC>(n);
    ...
    { // Spell with effects
        records::Spell s{}; s.mId="fireball"; s.mData.mCost=15;
        s.mEffects.mList.push_back({14,-1,-1,2,0,30,5,25});
        auto b=trip<records::Spell,ESM::Spell>(s);
