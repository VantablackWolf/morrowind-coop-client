...
static records::ActiveEffect trip(records::ActiveEffect in){
    ESM::ActiveEffect e{}; RecordConvert::toEngine(in,e);
    records::ActiveEffect o{}; RecordConvert::fromEngine(e,o); return o; }
int main()
{
    // DrainSkill (effect 24) targeting Long Blade (skill 5)
    { records::ActiveEffect a{}; a.mEffectId=ESM::MagicEffect::refIdToIndex(ESM::MagicEffect::DrainSkill);
    ...
    { records::ActiveEffect a{}; a.mEffectId=ESM::MagicEffect::refIdToIndex(ESM::MagicEffect::DamageAttribute);
      a.mArg=0; auto b=trip(a);
      ck("DamageAttribute arg resolves as attribute 0", b.mArg==0); }
    // FortifyAttribute targeting Luck (attribute 7)
    { records::ActiveEffect a{}; a.mEffectId=ESM::MagicEffect::refIdToIndex(ESM::MagicEffect::FortifyAttribute);
      a.mArg=7; auto b=trip(a);
      ck("FortifyAttribute arg 7 round-trips", b.mArg==7); }
    // FireDamage: no skill/attribute arg
    { records::ActiveEffect a{}; a.mEffectId=ESM::MagicEffect::refIdToIndex(ESM::MagicEffect::FireDamage);
      a.mArg=-1; auto b=trip(a);
      ck("FireDamage keeps arg -1", b.mArg==-1); }
    // Summon: arg is an actor index, not a skill
    { records::ActiveEffect a{}; a.mEffectId=ESM::MagicEffect::refIdToIndex(ESM::MagicEffect::SummonScamp);
    ...
    { records::ActiveEffect a{}; a.mEffectId=14; a.mArg=-1; a.mMagnitude=7.f;
